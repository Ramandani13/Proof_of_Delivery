...
<form action="#" method="POST" name="form1">
        <table border="0"  ><br>
                ...
                <?php
                    include "koneksi.php";
                    $sqlqty=mysqli_query($koneksi,"SELECT SUM(act_qty) AS act_qty FROM tb_proses_packing WHERE order_number = '$order_number' and item_no = '$item_no' and month = '$bulan_nama2' and year = '$nama_tahun' ");
                    while ($dataqty = mysqli_fetch_array($sqlqty)){
                        $act_qty = $dataqty['act_qty'];      
                ?>
                <?php
            ...
            <tr> 
                <td><center><input style="width:300px;border-radius:5px;background-color:#FFE4C4;text-align:center;color:blue;" type="text" name="palet_no" required="3" placeholder="Isi No Palet" required="3"></center></td>
            </tr> 
    ...
    if(isset($_POST['Submit'])) {
            ...
            if(mysqli_num_rows($cekdata) == 1){
                include "koneksi.php";
                    $dataactproses = mysqli_query($koneksi,"SELECT act_qty AS act_qty FROM tb_proses_packing WHERE order_number = '$order' and item_no = '$item_no' and month = '$bulan_nama2' and year = '$nama_tahun' ");
                    while ($dataact = mysqli_fetch_array($dataactproses)){
                        $act_qty = $dataact['act_qty'];   
                    }
                $total_act =  $act_qty +  $qty ;
                $result = mysqli_query($koneksi, "INSERT INTO tb_record_packing(tgl,order_number,item_no,qty,pengguna,grup,month,year,palet_no,indikator) VALUES ('$tanggal_ori','$order','$item_no','$qty','$getusername','$grup','$bulan_nama2','$nama_tahun','$palet_no','2')");
                $result = mysqli_query($koneksi, "INSERT INTO tb_record_packing_to_ritase(tgl,order_number,item_no,qty,pengguna,grup,month,year,palet_no,indikator) VALUES ('$tanggal_ori','$order','$item_no','$qty','$getusername','$grup','$bulan_nama2','$nama_tahun','$palet_no','2')");
                // $ritase = mysqli_query($koneksi, "INSERT INTO tb_ritase_packing(tgl,order_number,item_no,qty,pengguna,grup,month,year,palet_no) VALUES ('$tanggal_ori','$order','$item_no','$qty','$getusername','$grup','$bulan_nama2','$nama_tahun','$palet_no')");
                $result1 = mysqli_query($koneksi, "UPDATE tb_proses_packing SET actual_packing = '$tanggal_ori',act_qty = '$total_act' WHERE order_number = '$order' and item_no='$item_no'  and month = '$bulan_nama2' and year = '$nama_tahun' ");
                
            }else{
         // Insert user data into table
            echo '<script>alert("Data Tidak Ditemukan...!")</script>';
                echo '<META HTTP-EQUIV="Refresh" Content="3; URL=pod_proses_packing.php ">';
    ...
    ?>
<button style="position:relative;top:-70px;left:15px;width:150px;height:25px;border-radius:5px;background-image: linear-gradient(to bottom right, lime, white);"><a href="record_proses_packing.php" ><b style="color:black;">Record Data</b></a></button>&nbsp;
<button style="position:relative;top:-70px;left:15px;width:150px;height:25px;border-radius:5px;background-image: linear-gradient(to bottom right, lime, white);"><a href="siap_ritase.php" ><b style="color:black;">Siap Ritase</b></a></button>&nbsp;
<button style="position:relative;top:-70px;left:15px;width:150px;height:25px;border-radius:5px;background-image: linear-gradient(to bottom right, yellow, white);"><a href="ritase_proses_packing.php" ><b style="color:black;">Ritase</b></a></button>&nbsp;
<button style="position:relative;top:-70px;left:15px;width:150px;height:25px;border-radius:5px;background-image: linear-gradient(to bottom right, blue, white);"><a href="record_proses_packing.php" ><b style="color:black;">Download Data</b></a></button>
<div class="scroll1">
<h4><b>Pod Daily Report</b></h4>
    <table class="table table-hover my-0">
        ...
        <?php
            ...
            ?>
            <?php
            $ambildata2 = mysqli_query($koneksi,"SELECT SUM(act_qty) AS act_qty FROM tb_proses_packing where month = '$bulan_nama2' and year = '$nama_tahun' ");                        
            while($tampil2 = mysqli_fetch_array($ambildata2)){
                $act_qty = $tampil2['act_qty'];
            ?>
            <?php
                $balance_total = $act_qty - $indicated_qty ;
            ?>
            <tr>
                ...
                <td><center><b><?php echo $act_qty ; ?></b></center></td>
...
<table class="table table-hover my-0">
        ...
        <thead>
            <tr>
                ...
                <th class="d-none d-md-table-cell" style="color:white;" id="gradient3"><center>PALET</center></th>                              
                <th class="d-none d-md-table-cell" style="color:white;" id="gradient3"><center>TOTAL QTY</center></th>
        ...
        <?php
            ...
            $no=1;
            $ambildata3 = mysqli_query($koneksi,"SELECT DISTINCT order_number,item_no,palet_no,indikator  FROM tb_record_packing where month = '$bulan_nama2' and year = '$nama_tahun' ORDER BY palet_no ASC");                        
            while($tampil3 = mysqli_fetch_array($ambildata3)){
                    $order_number = $tampil3['order_number'] ;
                    $item_no = $tampil3['item_no'] ;
                    $palet_no = $tampil3['palet_no'];
                    $indikator = $tampil3['indikator'];
            ?>

            <?php
                include "koneksi.php";
                $dani = mysqli_query($koneksi,"SELECT count(palet_no) as totall FROM tb_record_packing WHERE palet_no = '$palet_no' and item_no = '$item_no' and order_number = '$order_number' and month = '$bulan_nama2' and year = '$nama_tahun'  ");
                while($data1 = mysqli_fetch_array($dani)) { 
                    $totall = $data1['totall'];
            ...
            <tr>
                ...
                <td><center><b><?php echo $order_number ; ?></b></center></td>
                <td><center><b><?php echo $item_no ; ?></b></center></td>
                <td><center><b><?php echo $palet_no ; ?></b></center></td>
                <td><center><b><?php echo $totall ; ?></b></center></td>
...
<table class="table table-hover my-0">
                                    ...
                                    <tr>
                                        ...
                                        <td><center><b><?php echo $tampil['actual_packing']; ?></b></center></td>
                                        <td><center><b><?php echo $tampil['act_qty']; ?></b></center></td>
                                       
                    
										<td><?php
										if ($tampil['actual_packing'] > $tampil['indicated_day'])  { 																					
											echo '<center><p style="color:red;">DELAY</p></center>';																			
										}elseif ($tampil['actual_packing'] == $tampil['indicated_day']){
                                        ...
                                        <td><center><?php
                                            echo $tampil['act_qty'] - $tampil['indicated_qty']  ;
										?></center></td>

                                        <td><?php
										if ($tampil['act_qty'] > $tampil['indicated_qty'])  { 																					
											echo '<center><p style="color:green;">COMPLETED</p></center>';																			
										}elseif ($tampil['act_qty'] == $tampil['indicated_qty']){
											echo '<center><p style="color:green;">COMPLETED</p></center>';		
										}else{
